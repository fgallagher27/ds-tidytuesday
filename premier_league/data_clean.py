...
subset_pl_df = premier_leauge.loc[:, ['Date', 'HomeTeam', 'AwayTeam', 'HF', 'AF', 'HY', 'AY', 'HR', 'AR']].rename(columns={
    'HF': 'home_fouls',
    'AF': 'away_fouls',
    'HY': 'home_yellows',
    'AY': 'away_yellows',
...
check_na(list(long_df), long_df)

pickle_out = open("long_premier_leauge_df.pickle","wb")
